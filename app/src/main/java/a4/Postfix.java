...
public class Postfix {
     ...
     * operators follow their operands. The expression is given as a deque of
     * tokens, where each token is either a Double (operand) or a Character
     * (operator).
     *
     ...
     * (operator).
     * @return A Double representing the result of evaluating the postfix
     * expression
     * @throws IllegalArgumentException If there are not enough operands for an
     * operator, or if there is an unknown operator in the expression.
     * @throws ArithmeticException If division by zero is attempted in the
     * expression.
     */
